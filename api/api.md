...
- [API Documentation](#api-documentation)
  ...
  - [<a name="lorawan-stack/api/_api.proto">File `lorawan-stack/api/_api.proto`</a>](#file-lorawan-stackapi_apiproto)
  - [<a name="lorawan-stack/api/application.proto">File `lorawan-stack/api/application.proto`</a>](#file-lorawan-stackapiapplicationproto)
    - [<a name="ttn.lorawan.v3.Application">Message `Application`</a>](#message-application)
      - [Field Rules](#field-rules)
    - [<a name="ttn.lorawan.v3.Application.AttributesEntry">Message `Application.AttributesEntry`</a>](#message-applicationattributesentry)
    - [<a name="ttn.lorawan.v3.Applications">Message `Applications`</a>](#message-applications)
    - [<a name="ttn.lorawan.v3.CreateApplicationAPIKeyRequest">Message `CreateApplicationAPIKeyRequest`</a>](#message-createapplicationapikeyrequest)
      - [Field Rules](#field-rules-1)
    - [<a name="ttn.lorawan.v3.CreateApplicationRequest">Message `CreateApplicationRequest`</a>](#message-createapplicationrequest)
      - [Field Rules](#field-rules-2)
    - [<a name="ttn.lorawan.v3.GetApplicationAPIKeyRequest">Message `GetApplicationAPIKeyRequest`</a>](#message-getapplicationapikeyrequest)
      - [Field Rules](#field-rules-3)
    - [<a name="ttn.lorawan.v3.GetApplicationCollaboratorRequest">Message `GetApplicationCollaboratorRequest`</a>](#message-getapplicationcollaboratorrequest)
      - [Field Rules](#field-rules-4)
    - [<a name="ttn.lorawan.v3.GetApplicationRequest">Message `GetApplicationRequest`</a>](#message-getapplicationrequest)
      - [Field Rules](#field-rules-5)
    - [<a name="ttn.lorawan.v3.ListApplicationAPIKeysRequest">Message `ListApplicationAPIKeysRequest`</a>](#message-listapplicationapikeysrequest)
      - [Field Rules](#field-rules-6)
    - [<a name="ttn.lorawan.v3.ListApplicationCollaboratorsRequest">Message `ListApplicationCollaboratorsRequest`</a>](#message-listapplicationcollaboratorsrequest)
      - [Field Rules](#field-rules-7)
    - [<a name="ttn.lorawan.v3.ListApplicationsRequest">Message `ListApplicationsRequest`</a>](#message-listapplicationsrequest)
      - [Field Rules](#field-rules-8)
    - [<a name="ttn.lorawan.v3.SetApplicationCollaboratorRequest">Message `SetApplicationCollaboratorRequest`</a>](#message-setapplicationcollaboratorrequest)
      - [Field Rules](#field-rules-9)
    - [<a name="ttn.lorawan.v3.UpdateApplicationAPIKeyRequest">Message `UpdateApplicationAPIKeyRequest`</a>](#message-updateapplicationapikeyrequest)
      - [Field Rules](#field-rules-10)
    - [<a name="ttn.lorawan.v3.UpdateApplicationRequest">Message `UpdateApplicationRequest`</a>](#message-updateapplicationrequest)
      - [Field Rules](#field-rules-11)
  - [<a name="lorawan-stack/api/application_services.proto">File `lorawan-stack/api/application_services.proto`</a>](#file-lorawan-stackapiapplication_servicesproto)
    - [<a name="ttn.lorawan.v3.ApplicationAccess">Service `ApplicationAccess`</a>](#service-applicationaccess)
      - [HTTP bindings](#http-bindings)
    - [<a name="ttn.lorawan.v3.ApplicationRegistry">Service `ApplicationRegistry`</a>](#service-applicationregistry)
      - [HTTP bindings](#http-bindings-1)
  - [<a name="lorawan-stack/api/applicationserver.proto">File `lorawan-stack/api/applicationserver.proto`</a>](#file-lorawan-stackapiapplicationserverproto)
    - [<a name="ttn.lorawan.v3.ApplicationLink">Message `ApplicationLink`</a>](#message-applicationlink)
    - [<a name="ttn.lorawan.v3.ApplicationLinkStats">Message `ApplicationLinkStats`</a>](#message-applicationlinkstats)
      - [Field Rules](#field-rules-12)
    - [<a name="ttn.lorawan.v3.AsConfiguration">Message `AsConfiguration`</a>](#message-asconfiguration)
    - [<a name="ttn.lorawan.v3.AsConfiguration.PubSub">Message `AsConfiguration.PubSub`</a>](#message-asconfigurationpubsub)
    - [<a name="ttn.lorawan.v3.AsConfiguration.PubSub.Providers">Message `AsConfiguration.PubSub.Providers`</a>](#message-asconfigurationpubsubproviders)
    - [<a name="ttn.lorawan.v3.DecodeDownlinkRequest">Message `DecodeDownlinkRequest`</a>](#message-decodedownlinkrequest)
      - [Field Rules](#field-rules-13)
    - [<a name="ttn.lorawan.v3.DecodeDownlinkResponse">Message `DecodeDownlinkResponse`</a>](#message-decodedownlinkresponse)
    - [<a name="ttn.lorawan.v3.DecodeUplinkRequest">Message `DecodeUplinkRequest`</a>](#message-decodeuplinkrequest)
      - [Field Rules](#field-rules-14)
    - [<a name="ttn.lorawan.v3.DecodeUplinkResponse">Message `DecodeUplinkResponse`</a>](#message-decodeuplinkresponse)
    - [<a name="ttn.lorawan.v3.EncodeDownlinkRequest">Message `EncodeDownlinkRequest`</a>](#message-encodedownlinkrequest)
      - [Field Rules](#field-rules-15)
    - [<a name="ttn.lorawan.v3.EncodeDownlinkResponse">Message `EncodeDownlinkResponse`</a>](#message-encodedownlinkresponse)
    - [<a name="ttn.lorawan.v3.GetApplicationLinkRequest">Message `GetApplicationLinkRequest`</a>](#message-getapplicationlinkrequest)
      - [Field Rules](#field-rules-16)
    - [<a name="ttn.lorawan.v3.GetAsConfigurationRequest">Message `GetAsConfigurationRequest`</a>](#message-getasconfigurationrequest)
    - [<a name="ttn.lorawan.v3.GetAsConfigurationResponse">Message `GetAsConfigurationResponse`</a>](#message-getasconfigurationresponse)
    - [<a name="ttn.lorawan.v3.NsAsHandleUplinkRequest">Message `NsAsHandleUplinkRequest`</a>](#message-nsashandleuplinkrequest)
      - [Field Rules](#field-rules-17)
    - [<a name="ttn.lorawan.v3.SetApplicationLinkRequest">Message `SetApplicationLinkRequest`</a>](#message-setapplicationlinkrequest)
      - [Field Rules](#field-rules-18)
    - [<a name="ttn.lorawan.v3.AsConfiguration.PubSub.Providers.Status">Enum `AsConfiguration.PubSub.Providers.Status`</a>](#enum-asconfigurationpubsubprovidersstatus)
    - [<a name="ttn.lorawan.v3.AppAs">Service `AppAs`</a>](#service-appas)
      - [HTTP bindings](#http-bindings-2)
    - [<a name="ttn.lorawan.v3.As">Service `As`</a>](#service-as)
      - [HTTP bindings](#http-bindings-3)
    - [<a name="ttn.lorawan.v3.AsEndDeviceRegistry">Service `AsEndDeviceRegistry`</a>](#service-asenddeviceregistry)
      - [HTTP bindings](#http-bindings-4)
    - [<a name="ttn.lorawan.v3.NsAs">Service `NsAs`</a>](#service-nsas)
  - [<a name="lorawan-stack/api/applicationserver_integrations_storage.proto">File `lorawan-stack/api/applicationserver_integrations_storage.proto`</a>](#file-lorawan-stackapiapplicationserver_integrations_storageproto)
    - [<a name="ttn.lorawan.v3.GetStoredApplicationUpRequest">Message `GetStoredApplicationUpRequest`</a>](#message-getstoredapplicationuprequest)
      - [Field Rules](#field-rules-19)
    - [<a name="ttn.lorawan.v3.ApplicationUpStorage">Service `ApplicationUpStorage`</a>](#service-applicationupstorage)
      - [HTTP bindings](#http-bindings-5)
  - [<a name="lorawan-stack/api/applicationserver_packages.proto">File `lorawan-stack/api/applicationserver_packages.proto`</a>](#file-lorawan-stackapiapplicationserver_packagesproto)
    - [<a name="ttn.lorawan.v3.ApplicationPackage">Message `ApplicationPackage`</a>](#message-applicationpackage)
      - [Field Rules](#field-rules-20)
    - [<a name="ttn.lorawan.v3.ApplicationPackageAssociation">Message `ApplicationPackageAssociation`</a>](#message-applicationpackageassociation)
      - [Field Rules](#field-rules-21)
    - [<a name="ttn.lorawan.v3.ApplicationPackageAssociationIdentifiers">Message `ApplicationPackageAssociationIdentifiers`</a>](#message-applicationpackageassociationidentifiers)
      - [Field Rules](#field-rules-22)
    - [<a name="ttn.lorawan.v3.ApplicationPackageAssociations">Message `ApplicationPackageAssociations`</a>](#message-applicationpackageassociations)
    - [<a name="ttn.lorawan.v3.ApplicationPackageDefaultAssociation">Message `ApplicationPackageDefaultAssociation`</a>](#message-applicationpackagedefaultassociation)
      - [Field Rules](#field-rules-23)
    - [<a name="ttn.lorawan.v3.ApplicationPackageDefaultAssociationIdentifiers">Message `ApplicationPackageDefaultAssociationIdentifiers`</a>](#message-applicationpackagedefaultassociationidentifiers)
      - [Field Rules](#field-rules-24)
    - [<a name="ttn.lorawan.v3.ApplicationPackageDefaultAssociations">Message `ApplicationPackageDefaultAssociations`</a>](#message-applicationpackagedefaultassociations)
    - [<a name="ttn.lorawan.v3.ApplicationPackages">Message `ApplicationPackages`</a>](#message-applicationpackages)
    - [<a name="ttn.lorawan.v3.GetApplicationPackageAssociationRequest">Message `GetApplicationPackageAssociationRequest`</a>](#message-getapplicationpackageassociationrequest)
      - [Field Rules](#field-rules-25)
    - [<a name="ttn.lorawan.v3.GetApplicationPackageDefaultAssociationRequest">Message `GetApplicationPackageDefaultAssociationRequest`</a>](#message-getapplicationpackagedefaultassociationrequest)
      - [Field Rules](#field-rules-26)
    - [<a name="ttn.lorawan.v3.ListApplicationPackageAssociationRequest">Message `ListApplicationPackageAssociationRequest`</a>](#message-listapplicationpackageassociationrequest)
      - [Field Rules](#field-rules-27)
    - [<a name="ttn.lorawan.v3.ListApplicationPackageDefaultAssociationRequest">Message `ListApplicationPackageDefaultAssociationRequest`</a>](#message-listapplicationpackagedefaultassociationrequest)
      - [Field Rules](#field-rules-28)
    - [<a name="ttn.lorawan.v3.SetApplicationPackageAssociationRequest">Message `SetApplicationPackageAssociationRequest`</a>](#message-setapplicationpackageassociationrequest)
      - [Field Rules](#field-rules-29)
    - [<a name="ttn.lorawan.v3.SetApplicationPackageDefaultAssociationRequest">Message `SetApplicationPackageDefaultAssociationRequest`</a>](#message-setapplicationpackagedefaultassociationrequest)
      - [Field Rules](#field-rules-30)
    - [<a name="ttn.lorawan.v3.ApplicationPackageRegistry">Service `ApplicationPackageRegistry`</a>](#service-applicationpackageregistry)
      - [HTTP bindings](#http-bindings-6)
  - [<a name="lorawan-stack/api/applicationserver_pubsub.proto">File `lorawan-stack/api/applicationserver_pubsub.proto`</a>](#file-lorawan-stackapiapplicationserver_pubsubproto)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub">Message `ApplicationPubSub`</a>](#message-applicationpubsub)
      - [Field Rules](#field-rules-31)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.AWSIoTProvider">Message `ApplicationPubSub.AWSIoTProvider`</a>](#message-applicationpubsubawsiotprovider)
      - [Field Rules](#field-rules-32)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.AWSIoTProvider.AccessKey">Message `ApplicationPubSub.AWSIoTProvider.AccessKey`</a>](#message-applicationpubsubawsiotprovideraccesskey)
      - [Field Rules](#field-rules-33)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.AWSIoTProvider.AssumeRole">Message `ApplicationPubSub.AWSIoTProvider.AssumeRole`</a>](#message-applicationpubsubawsiotproviderassumerole)
      - [Field Rules](#field-rules-34)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.AWSIoTProvider.DefaultIntegration">Message `ApplicationPubSub.AWSIoTProvider.DefaultIntegration`</a>](#message-applicationpubsubawsiotproviderdefaultintegration)
      - [Field Rules](#field-rules-35)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.MQTTProvider">Message `ApplicationPubSub.MQTTProvider`</a>](#message-applicationpubsubmqttprovider)
      - [Field Rules](#field-rules-36)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.MQTTProvider.HeadersEntry">Message `ApplicationPubSub.MQTTProvider.HeadersEntry`</a>](#message-applicationpubsubmqttproviderheadersentry)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.Message">Message `ApplicationPubSub.Message`</a>](#message-applicationpubsubmessage)
      - [Field Rules](#field-rules-37)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.NATSProvider">Message `ApplicationPubSub.NATSProvider`</a>](#message-applicationpubsubnatsprovider)
      - [Field Rules](#field-rules-38)
    - [<a name="ttn.lorawan.v3.ApplicationPubSubFormats">Message `ApplicationPubSubFormats`</a>](#message-applicationpubsubformats)
    - [<a name="ttn.lorawan.v3.ApplicationPubSubFormats.FormatsEntry">Message `ApplicationPubSubFormats.FormatsEntry`</a>](#message-applicationpubsubformatsformatsentry)
    - [<a name="ttn.lorawan.v3.ApplicationPubSubIdentifiers">Message `ApplicationPubSubIdentifiers`</a>](#message-applicationpubsubidentifiers)
      - [Field Rules](#field-rules-39)
    - [<a name="ttn.lorawan.v3.ApplicationPubSubs">Message `ApplicationPubSubs`</a>](#message-applicationpubsubs)
    - [<a name="ttn.lorawan.v3.GetApplicationPubSubRequest">Message `GetApplicationPubSubRequest`</a>](#message-getapplicationpubsubrequest)
      - [Field Rules](#field-rules-40)
    - [<a name="ttn.lorawan.v3.ListApplicationPubSubsRequest">Message `ListApplicationPubSubsRequest`</a>](#message-listapplicationpubsubsrequest)
      - [Field Rules](#field-rules-41)
    - [<a name="ttn.lorawan.v3.SetApplicationPubSubRequest">Message `SetApplicationPubSubRequest`</a>](#message-setapplicationpubsubrequest)
      - [Field Rules](#field-rules-42)
    - [<a name="ttn.lorawan.v3.ApplicationPubSub.MQTTProvider.QoS">Enum `ApplicationPubSub.MQTTProvider.QoS`</a>](#enum-applicationpubsubmqttproviderqos)
    - [<a name="ttn.lorawan.v3.ApplicationPubSubRegistry">Service `ApplicationPubSubRegistry`</a>](#service-applicationpubsubregistry)
      - [HTTP bindings](#http-bindings-7)
  - [<a name="lorawan-stack/api/applicationserver_web.proto">File `lorawan-stack/api/applicationserver_web.proto`</a>](#file-lorawan-stackapiapplicationserver_webproto)
    - [<a name="ttn.lorawan.v3.ApplicationWebhook">Message `ApplicationWebhook`</a>](#message-applicationwebhook)
      - [Field Rules](#field-rules-43)
    - [<a name="ttn.lorawan.v3.ApplicationWebhook.HeadersEntry">Message `ApplicationWebhook.HeadersEntry`</a>](#message-applicationwebhookheadersentry)
    - [<a name="ttn.lorawan.v3.ApplicationWebhook.Message">Message `ApplicationWebhook.Message`</a>](#message-applicationwebhookmessage)
      - [Field Rules](#field-rules-44)
    - [<a name="ttn.lorawan.v3.ApplicationWebhook.TemplateFieldsEntry">Message `ApplicationWebhook.TemplateFieldsEntry`</a>](#message-applicationwebhooktemplatefieldsentry)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookFormats">Message `ApplicationWebhookFormats`</a>](#message-applicationwebhookformats)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookFormats.FormatsEntry">Message `ApplicationWebhookFormats.FormatsEntry`</a>](#message-applicationwebhookformatsformatsentry)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookIdentifiers">Message `ApplicationWebhookIdentifiers`</a>](#message-applicationwebhookidentifiers)
      - [Field Rules](#field-rules-45)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookTemplate">Message `ApplicationWebhookTemplate`</a>](#message-applicationwebhooktemplate)
      - [Field Rules](#field-rules-46)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookTemplate.HeadersEntry">Message `ApplicationWebhookTemplate.HeadersEntry`</a>](#message-applicationwebhooktemplateheadersentry)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookTemplate.Message">Message `ApplicationWebhookTemplate.Message`</a>](#message-applicationwebhooktemplatemessage)
      - [Field Rules](#field-rules-47)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookTemplateField">Message `ApplicationWebhookTemplateField`</a>](#message-applicationwebhooktemplatefield)
      - [Field Rules](#field-rules-48)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookTemplateIdentifiers">Message `ApplicationWebhookTemplateIdentifiers`</a>](#message-applicationwebhooktemplateidentifiers)
      - [Field Rules](#field-rules-49)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookTemplates">Message `ApplicationWebhookTemplates`</a>](#message-applicationwebhooktemplates)
    - [<a name="ttn.lorawan.v3.ApplicationWebhooks">Message `ApplicationWebhooks`</a>](#message-applicationwebhooks)
    - [<a name="ttn.lorawan.v3.GetApplicationWebhookRequest">Message `GetApplicationWebhookRequest`</a>](#message-getapplicationwebhookrequest)
      - [Field Rules](#field-rules-50)
    - [<a name="ttn.lorawan.v3.GetApplicationWebhookTemplateRequest">Message `GetApplicationWebhookTemplateRequest`</a>](#message-getapplicationwebhooktemplaterequest)
      - [Field Rules](#field-rules-51)
    - [<a name="ttn.lorawan.v3.ListApplicationWebhookTemplatesRequest">Message `ListApplicationWebhookTemplatesRequest`</a>](#message-listapplicationwebhooktemplatesrequest)
    - [<a name="ttn.lorawan.v3.ListApplicationWebhooksRequest">Message `ListApplicationWebhooksRequest`</a>](#message-listapplicationwebhooksrequest)
      - [Field Rules](#field-rules-52)
    - [<a name="ttn.lorawan.v3.SetApplicationWebhookRequest">Message `SetApplicationWebhookRequest`</a>](#message-setapplicationwebhookrequest)
      - [Field Rules](#field-rules-53)
    - [<a name="ttn.lorawan.v3.ApplicationWebhookRegistry">Service `ApplicationWebhookRegistry`</a>](#service-applicationwebhookregistry)
      - [HTTP bindings](#http-bindings-8)
  - [<a name="lorawan-stack/api/client.proto">File `lorawan-stack/api/client.proto`</a>](#file-lorawan-stackapiclientproto)
    - [<a name="ttn.lorawan.v3.Client">Message `Client`</a>](#message-client)
      - [Field Rules](#field-rules-54)
    - [<a name="ttn.lorawan.v3.Client.AttributesEntry">Message `Client.AttributesEntry`</a>](#message-clientattributesentry)
    - [<a name="ttn.lorawan.v3.Clients">Message `Clients`</a>](#message-clients)
    - [<a name="ttn.lorawan.v3.CreateClientRequest">Message `CreateClientRequest`</a>](#message-createclientrequest)
      - [Field Rules](#field-rules-55)
    - [<a name="ttn.lorawan.v3.GetClientCollaboratorRequest">Message `GetClientCollaboratorRequest`</a>](#message-getclientcollaboratorrequest)
      - [Field Rules](#field-rules-56)
    - [<a name="ttn.lorawan.v3.GetClientRequest">Message `GetClientRequest`</a>](#message-getclientrequest)
      - [Field Rules](#field-rules-57)
    - [<a name="ttn.lorawan.v3.ListClientCollaboratorsRequest">Message `ListClientCollaboratorsRequest`</a>](#message-listclientcollaboratorsrequest)
      - [Field Rules](#field-rules-58)
    - [<a name="ttn.lorawan.v3.ListClientsRequest">Message `ListClientsRequest`</a>](#message-listclientsrequest)
      - [Field Rules](#field-rules-59)
    - [<a name="ttn.lorawan.v3.SetClientCollaboratorRequest">Message `SetClientCollaboratorRequest`</a>](#message-setclientcollaboratorrequest)
      - [Field Rules](#field-rules-60)
    - [<a name="ttn.lorawan.v3.UpdateClientRequest">Message `UpdateClientRequest`</a>](#message-updateclientrequest)
      - [Field Rules](#field-rules-61)
    - [<a name="ttn.lorawan.v3.GrantType">Enum `GrantType`</a>](#enum-granttype)
  - [<a name="lorawan-stack/api/client_services.proto">File `lorawan-stack/api/client_services.proto`</a>](#file-lorawan-stackapiclient_servicesproto)
    - [<a name="ttn.lorawan.v3.ClientAccess">Service `ClientAccess`</a>](#service-clientaccess)
      - [HTTP bindings](#http-bindings-9)
    - [<a name="ttn.lorawan.v3.ClientRegistry">Service `ClientRegistry`</a>](#service-clientregistry)
      - [HTTP bindings](#http-bindings-10)
  - [<a name="lorawan-stack/api/cluster.proto">File `lorawan-stack/api/cluster.proto`</a>](#file-lorawan-stackapiclusterproto)
    - [<a name="ttn.lorawan.v3.PeerInfo">Message `PeerInfo`</a>](#message-peerinfo)
    - [<a name="ttn.lorawan.v3.PeerInfo.TagsEntry">Message `PeerInfo.TagsEntry`</a>](#message-peerinfotagsentry)
  - [<a name="lorawan-stack/api/configuration_services.proto">File `lorawan-stack/api/configuration_services.proto`</a>](#file-lorawan-stackapiconfiguration_servicesproto)
    - [<a name="ttn.lorawan.v3.FrequencyPlanDescription">Message `FrequencyPlanDescription`</a>](#message-frequencyplandescription)
    - [<a name="ttn.lorawan.v3.ListFrequencyPlansRequest">Message `ListFrequencyPlansRequest`</a>](#message-listfrequencyplansrequest)
    - [<a name="ttn.lorawan.v3.ListFrequencyPlansResponse">Message `ListFrequencyPlansResponse`</a>](#message-listfrequencyplansresponse)
    - [<a name="ttn.lorawan.v3.Configuration">Service `Configuration`</a>](#service-configuration)
      - [HTTP bindings](#http-bindings-11)
  - [<a name="lorawan-stack/api/contact_info.proto">File `lorawan-stack/api/contact_info.proto`</a>](#file-lorawan-stackapicontact_infoproto)
    - [<a name="ttn.lorawan.v3.ContactInfo">Message `ContactInfo`</a>](#message-contactinfo)
      - [Field Rules](#field-rules-62)
    - [<a name="ttn.lorawan.v3.ContactInfoValidation">Message `ContactInfoValidation`</a>](#message-contactinfovalidation)
      - [Field Rules](#field-rules-63)
    - [<a name="ttn.lorawan.v3.ContactMethod">Enum `ContactMethod`</a>](#enum-contactmethod)
    - [<a name="ttn.lorawan.v3.ContactType">Enum `ContactType`</a>](#enum-contacttype)
    - [<a name="ttn.lorawan.v3.ContactInfoRegistry">Service `ContactInfoRegistry`</a>](#service-contactinforegistry)
      - [HTTP bindings](#http-bindings-12)
  - [<a name="lorawan-stack/api/deviceclaimingserver.proto">File `lorawan-stack/api/deviceclaimingserver.proto`</a>](#file-lorawan-stackapideviceclaimingserverproto)
    - [<a name="ttn.lorawan.v3.AuthorizeApplicationRequest">Message `AuthorizeApplicationRequest`</a>](#message-authorizeapplicationrequest)
      - [Field Rules](#field-rules-64)
    - [<a name="ttn.lorawan.v3.AuthorizeGatewayRequest">Message `AuthorizeGatewayRequest`</a>](#message-authorizegatewayrequest)
      - [Field Rules](#field-rules-65)
    - [<a name="ttn.lorawan.v3.CUPSRedirection">Message `CUPSRedirection`</a>](#message-cupsredirection)
      - [Field Rules](#field-rules-66)
    - [<a name="ttn.lorawan.v3.ClaimEndDeviceRequest">Message `ClaimEndDeviceRequest`</a>](#message-claimenddevicerequest)
      - [Field Rules](#field-rules-67)
    - [<a name="ttn.lorawan.v3.ClaimEndDeviceRequest.AuthenticatedIdentifiers">Message `ClaimEndDeviceRequest.AuthenticatedIdentifiers`</a>](#message-claimenddevicerequestauthenticatedidentifiers)
      - [Field Rules](#field-rules-68)
    - [<a name="ttn.lorawan.v3.ClaimGatewayRequest">Message `ClaimGatewayRequest`</a>](#message-claimgatewayrequest)
      - [Field Rules](#field-rules-69)
    - [<a name="ttn.lorawan.v3.ClaimGatewayRequest.AuthenticatedIdentifiers">Message `ClaimGatewayRequest.AuthenticatedIdentifiers`</a>](#message-claimgatewayrequestauthenticatedidentifiers)
      - [Field Rules](#field-rules-70)
    - [<a name="ttn.lorawan.v3.EndDeviceClaimingServer">Service `EndDeviceClaimingServer`</a>](#service-enddeviceclaimingserver)
      - [HTTP bindings](#http-bindings-13)
    - [<a name="ttn.lorawan.v3.GatewayClaimingServer">Service `GatewayClaimingServer`</a>](#service-gatewayclaimingserver)
      - [HTTP bindings](#http-bindings-14)
  - [<a name="lorawan-stack/api/devicerepository.proto">File `lorawan-stack/api/devicerepository.proto`</a>](#file-lorawan-stackapidevicerepositoryproto)
    - [<a name="ttn.lorawan.v3.EndDeviceBrand">Message `EndDeviceBrand`</a>](#message-enddevicebrand)
      - [Field Rules](#field-rules-71)
    - [<a name="ttn.lorawan.v3.EndDeviceModel">Message `EndDeviceModel`</a>](#message-enddevicemodel)
      - [Field Rules](#field-rules-72)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.Battery">Message `EndDeviceModel.Battery`</a>](#message-enddevicemodelbattery)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.Compliances">Message `EndDeviceModel.Compliances`</a>](#message-enddevicemodelcompliances)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.Compliances.Compliance">Message `EndDeviceModel.Compliances.Compliance`</a>](#message-enddevicemodelcompliancescompliance)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.Dimensions">Message `EndDeviceModel.Dimensions`</a>](#message-enddevicemodeldimensions)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.FirmwareVersion">Message `EndDeviceModel.FirmwareVersion`</a>](#message-enddevicemodelfirmwareversion)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.FirmwareVersion.Profile">Message `EndDeviceModel.FirmwareVersion.Profile`</a>](#message-enddevicemodelfirmwareversionprofile)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.FirmwareVersion.ProfilesEntry">Message `EndDeviceModel.FirmwareVersion.ProfilesEntry`</a>](#message-enddevicemodelfirmwareversionprofilesentry)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.HardwareVersion">Message `EndDeviceModel.HardwareVersion`</a>](#message-enddevicemodelhardwareversion)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.OperatingConditions">Message `EndDeviceModel.OperatingConditions`</a>](#message-enddevicemodeloperatingconditions)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.OperatingConditions.Limits">Message `EndDeviceModel.OperatingConditions.Limits`</a>](#message-enddevicemodeloperatingconditionslimits)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.Photos">Message `EndDeviceModel.Photos`</a>](#message-enddevicemodelphotos)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.Reseller">Message `EndDeviceModel.Reseller`</a>](#message-enddevicemodelreseller)
    - [<a name="ttn.lorawan.v3.EndDeviceModel.Videos">Message `EndDeviceModel.Videos`</a>](#message-enddevicemodelvideos)
    - [<a name="ttn.lorawan.v3.GetEndDeviceBrandRequest">Message `GetEndDeviceBrandRequest`</a>](#message-getenddevicebrandrequest)
      - [Field Rules](#field-rules-73)
    - [<a name="ttn.lorawan.v3.GetEndDeviceModelRequest">Message `GetEndDeviceModelRequest`</a>](#message-getenddevicemodelrequest)
      - [Field Rules](#field-rules-74)
    - [<a name="ttn.lorawan.v3.GetPayloadFormatterRequest">Message `GetPayloadFormatterRequest`</a>](#message-getpayloadformatterrequest)
    - [<a name="ttn.lorawan.v3.GetTemplateRequest">Message `GetTemplateRequest`</a>](#message-gettemplaterequest)
    - [<a name="ttn.lorawan.v3.ListEndDeviceBrandsRequest">Message `ListEndDeviceBrandsRequest`</a>](#message-listenddevicebrandsrequest)
      - [Field Rules](#field-rules-75)
    - [<a name="ttn.lorawan.v3.ListEndDeviceBrandsResponse">Message `ListEndDeviceBrandsResponse`</a>](#message-listenddevicebrandsresponse)
    - [<a name="ttn.lorawan.v3.ListEndDeviceModelsRequest">Message `ListEndDeviceModelsRequest`</a>](#message-listenddevicemodelsrequest)
      - [Field Rules](#field-rules-76)
    - [<a name="ttn.lorawan.v3.ListEndDeviceModelsResponse">Message `ListEndDeviceModelsResponse`</a>](#message-listenddevicemodelsresponse)
    - [<a name="ttn.lorawan.v3.MessagePayloadFormatter">Message `MessagePayloadFormatter`</a>](#message-messagepayloadformatter)
      - [Field Rules](#field-rules-77)
    - [<a name="ttn.lorawan.v3.KeyProvisioning">Enum `KeyProvisioning`</a>](#enum-keyprovisioning)
    - [<a name="ttn.lorawan.v3.KeySecurity">Enum `KeySecurity`</a>](#enum-keysecurity)
    - [<a name="ttn.lorawan.v3.DeviceRepository">Service `DeviceRepository`</a>](#service-devicerepository)
      - [HTTP bindings](#http-bindings-15)
  - [<a name="lorawan-stack/api/end_device.proto">File `lorawan-stack/api/end_device.proto`</a>](#file-lorawan-stackapiend_deviceproto)
    - [<a name="ttn.lorawan.v3.BoolValue">Message `BoolValue`</a>](#message-boolvalue)
    - [<a name="ttn.lorawan.v3.ConvertEndDeviceTemplateRequest">Message `ConvertEndDeviceTemplateRequest`</a>](#message-convertenddevicetemplaterequest)
      - [Field Rules](#field-rules-78)
    - [<a name="ttn.lorawan.v3.CreateEndDeviceRequest">Message `CreateEndDeviceRequest`</a>](#message-createenddevicerequest)
      - [Field Rules](#field-rules-79)
    - [<a name="ttn.lorawan.v3.DevAddrPrefix">Message `DevAddrPrefix`</a>](#message-devaddrprefix)
    - [<a name="ttn.lorawan.v3.EndDevice">Message `EndDevice`</a>](#message-enddevice)
      - [Field Rules](#field-rules-80)
    - [<a name="ttn.lorawan.v3.EndDevice.AttributesEntry">Message `EndDevice.AttributesEntry`</a>](#message-enddeviceattributesentry)
    - [<a name="ttn.lorawan.v3.EndDevice.LocationsEntry">Message `EndDevice.LocationsEntry`</a>](#message-enddevicelocationsentry)
    - [<a name="ttn.lorawan.v3.EndDeviceAuthenticationCode">Message `EndDeviceAuthenticationCode`</a>](#message-enddeviceauthenticationcode)
      - [Field Rules](#field-rules-81)
    - [<a name="ttn.lorawan.v3.EndDeviceTemplate">Message `EndDeviceTemplate`</a>](#message-enddevicetemplate)
      - [Field Rules](#field-rules-82)
    - [<a name="ttn.lorawan.v3.EndDeviceTemplateFormat">Message `EndDeviceTemplateFormat`</a>](#message-enddevicetemplateformat)
      - [Field Rules](#field-rules-83)
    - [<a name="ttn.lorawan.v3.EndDeviceTemplateFormats">Message `EndDeviceTemplateFormats`</a>](#message-enddevicetemplateformats)
      - [Field Rules](#field-rules-84)
    - [<a name="ttn.lorawan.v3.EndDeviceTemplateFormats.FormatsEntry">Message `EndDeviceTemplateFormats.FormatsEntry`</a>](#message-enddevicetemplateformatsformatsentry)
    - [<a name="ttn.lorawan.v3.EndDeviceVersion">Message `EndDeviceVersion`</a>](#message-enddeviceversion)
      - [Field Rules](#field-rules-85)
    - [<a name="ttn.lorawan.v3.EndDeviceVersionIdentifiers">Message `EndDeviceVersionIdentifiers`</a>](#message-enddeviceversionidentifiers)
      - [Field Rules](#field-rules-86)
    - [<a name="ttn.lorawan.v3.EndDevices">Message `EndDevices`</a>](#message-enddevices)
    - [<a name="ttn.lorawan.v3.GetEndDeviceIdentifiersForEUIsRequest">Message `GetEndDeviceIdentifiersForEUIsRequest`</a>](#message-getenddeviceidentifiersforeuisrequest)
    - [<a name="ttn.lorawan.v3.GetEndDeviceRequest">Message `GetEndDeviceRequest`</a>](#message-getenddevicerequest)
      - [Field Rules](#field-rules-87)
    - [<a name="ttn.lorawan.v3.ListEndDevicesRequest">Message `ListEndDevicesRequest`</a>](#message-listenddevicesrequest)
      - [Field Rules](#field-rules-88)
    - [<a name="ttn.lorawan.v3.MACParameters">Message `MACParameters`</a>](#message-macparameters)
      - [Field Rules](#field-rules-89)
    - [<a name="ttn.lorawan.v3.MACParameters.Channel">Message `MACParameters.Channel`</a>](#message-macparameterschannel)
      - [Field Rules](#field-rules-90)
    - [<a name="ttn.lorawan.v3.MACSettings">Message `MACSettings`</a>](#message-macsettings)
      - [Field Rules](#field-rules-91)
    - [<a name="ttn.lorawan.v3.MACState">Message `MACState`</a>](#message-macstate)
      - [Field Rules](#field-rules-92)
    - [<a name="ttn.lorawan.v3.MACState.DataRateRange">Message `MACState.DataRateRange`</a>](#message-macstatedataraterange)
      - [Field Rules](#field-rules-93)
    - [<a name="ttn.lorawan.v3.MACState.DataRateRanges">Message `MACState.DataRateRanges`</a>](#message-macstatedatarateranges)
      - [Field Rules](#field-rules-94)
    - [<a name="ttn.lorawan.v3.MACState.JoinAccept">Message `MACState.JoinAccept`</a>](#message-macstatejoinaccept)
      - [Field Rules](#field-rules-95)
    - [<a name="ttn.lorawan.v3.MACState.JoinRequest">Message `MACState.JoinRequest`</a>](#message-macstatejoinrequest)
      - [Field Rules](#field-rules-96)
    - [<a name="ttn.lorawan.v3.MACState.RejectedDataRateRangesEntry">Message `MACState.RejectedDataRateRangesEntry`</a>](#message-macstaterejecteddataraterangesentry)
    - [<a name="ttn.lorawan.v3.ResetAndGetEndDeviceRequest">Message `ResetAndGetEndDeviceRequest`</a>](#message-resetandgetenddevicerequest)
      - [Field Rules](#field-rules-97)
    - [<a name="ttn.lorawan.v3.Session">Message `Session`</a>](#message-session)
      - [Field Rules](#field-rules-98)
    - [<a name="ttn.lorawan.v3.SetEndDeviceRequest">Message `SetEndDeviceRequest`</a>](#message-setenddevicerequest)
      - [Field Rules](#field-rules-99)
    - [<a name="ttn.lorawan.v3.UpdateEndDeviceRequest">Message `UpdateEndDeviceRequest`</a>](#message-updateenddevicerequest)
      - [Field Rules](#field-rules-100)
    - [<a name="ttn.lorawan.v3.PowerState">Enum `PowerState`</a>](#enum-powerstate)
  - [<a name="lorawan-stack/api/end_device_services.proto">File `lorawan-stack/api/end_device_services.proto`</a>](#file-lorawan-stackapiend_device_servicesproto)
    - [<a name="ttn.lorawan.v3.EndDeviceRegistry">Service `EndDeviceRegistry`</a>](#service-enddeviceregistry)
      - [HTTP bindings](#http-bindings-16)
    - [<a name="ttn.lorawan.v3.EndDeviceTemplateConverter">Service `EndDeviceTemplateConverter`</a>](#service-enddevicetemplateconverter)
      - [HTTP bindings](#http-bindings-17)
  - [<a name="lorawan-stack/api/enums.proto">File `lorawan-stack/api/enums.proto`</a>](#file-lorawan-stackapienumsproto)
    - [<a name="ttn.lorawan.v3.ClusterRole">Enum `ClusterRole`</a>](#enum-clusterrole)
    - [<a name="ttn.lorawan.v3.DownlinkPathConstraint">Enum `DownlinkPathConstraint`</a>](#enum-downlinkpathconstraint)
    - [<a name="ttn.lorawan.v3.State">Enum `State`</a>](#enum-state)
  - [<a name="lorawan-stack/api/error.proto">File `lorawan-stack/api/error.proto`</a>](#file-lorawan-stackapierrorproto)
    - [<a name="ttn.lorawan.v3.ErrorDetails">Message `ErrorDetails`</a>](#message-errordetails)
  - [<a name="lorawan-stack/api/events.proto">File `lorawan-stack/api/events.proto`</a>](#file-lorawan-stackapieventsproto)
    - [<a name="ttn.lorawan.v3.Event">Message `Event`</a>](#message-event)
      - [Field Rules](#field-rules-101)
    - [<a name="ttn.lorawan.v3.Event.Authentication">Message `Event.Authentication`</a>](#message-eventauthentication)
    - [<a name="ttn.lorawan.v3.Event.ContextEntry">Message `Event.ContextEntry`</a>](#message-eventcontextentry)
    - [<a name="ttn.lorawan.v3.StreamEventsRequest">Message `StreamEventsRequest`</a>](#message-streameventsrequest)
    - [<a name="ttn.lorawan.v3.Events">Service `Events`</a>](#service-events)
      - [HTTP bindings](#http-bindings-18)
  - [<a name="lorawan-stack/api/gateway.proto">File `lorawan-stack/api/gateway.proto`</a>](#file-lorawan-stackapigatewayproto)
    - [<a name="ttn.lorawan.v3.CreateGatewayAPIKeyRequest">Message `CreateGatewayAPIKeyRequest`</a>](#message-creategatewayapikeyrequest)
      - [Field Rules](#field-rules-102)
    - [<a name="ttn.lorawan.v3.CreateGatewayRequest">Message `CreateGatewayRequest`</a>](#message-creategatewayrequest)
      - [Field Rules](#field-rules-103)
    - [<a name="ttn.lorawan.v3.Gateway">Message `Gateway`</a>](#message-gateway)
      - [Field Rules](#field-rules-104)
    - [<a name="ttn.lorawan.v3.Gateway.AttributesEntry">Message `Gateway.AttributesEntry`</a>](#message-gatewayattributesentry)
    - [<a name="ttn.lorawan.v3.GatewayAntenna">Message `GatewayAntenna`</a>](#message-gatewayantenna)
      - [Field Rules](#field-rules-105)
    - [<a name="ttn.lorawan.v3.GatewayAntenna.AttributesEntry">Message `GatewayAntenna.AttributesEntry`</a>](#message-gatewayantennaattributesentry)
    - [<a name="ttn.lorawan.v3.GatewayBrand">Message `GatewayBrand`</a>](#message-gatewaybrand)
    - [<a name="ttn.lorawan.v3.GatewayClaimAuthenticationCode">Message `GatewayClaimAuthenticationCode`</a>](#message-gatewayclaimauthenticationcode)
    - [<a name="ttn.lorawan.v3.GatewayConnectionStats">Message `GatewayConnectionStats`</a>](#message-gatewayconnectionstats)
    - [<a name="ttn.lorawan.v3.GatewayConnectionStats.RoundTripTimes">Message `GatewayConnectionStats.RoundTripTimes`</a>](#message-gatewayconnectionstatsroundtriptimes)
      - [Field Rules](#field-rules-106)
    - [<a name="ttn.lorawan.v3.GatewayConnectionStats.SubBand">Message `GatewayConnectionStats.SubBand`</a>](#message-gatewayconnectionstatssubband)
    - [<a name="ttn.lorawan.v3.GatewayModel">Message `GatewayModel`</a>](#message-gatewaymodel)
      - [Field Rules](#field-rules-107)
    - [<a name="ttn.lorawan.v3.GatewayRadio">Message `GatewayRadio`</a>](#message-gatewayradio)
    - [<a name="ttn.lorawan.v3.GatewayRadio.TxConfiguration">Message `GatewayRadio.TxConfiguration`</a>](#message-gatewayradiotxconfiguration)
    - [<a name="ttn.lorawan.v3.GatewayStatus">Message `GatewayStatus`</a>](#message-gatewaystatus)
      - [Field Rules](#field-rules-108)
    - [<a name="ttn.lorawan.v3.GatewayStatus.MetricsEntry">Message `GatewayStatus.MetricsEntry`</a>](#message-gatewaystatusmetricsentry)
    - [<a name="ttn.lorawan.v3.GatewayStatus.VersionsEntry">Message `GatewayStatus.VersionsEntry`</a>](#message-gatewaystatusversionsentry)
    - [<a name="ttn.lorawan.v3.GatewayVersion">Message `GatewayVersion`</a>](#message-gatewayversion)
      - [Field Rules](#field-rules-109)
    - [<a name="ttn.lorawan.v3.GatewayVersionIdentifiers">Message `GatewayVersionIdentifiers`</a>](#message-gatewayversionidentifiers)
      - [Field Rules](#field-rules-110)
    - [<a name="ttn.lorawan.v3.Gateways">Message `Gateways`</a>](#message-gateways)
    - [<a name="ttn.lorawan.v3.GetGatewayAPIKeyRequest">Message `GetGatewayAPIKeyRequest`</a>](#message-getgatewayapikeyrequest)
      - [Field Rules](#field-rules-111)
    - [<a name="ttn.lorawan.v3.GetGatewayCollaboratorRequest">Message `GetGatewayCollaboratorRequest`</a>](#message-getgatewaycollaboratorrequest)
      - [Field Rules](#field-rules-112)
    - [<a name="ttn.lorawan.v3.GetGatewayIdentifiersForEUIRequest">Message `GetGatewayIdentifiersForEUIRequest`</a>](#message-getgatewayidentifiersforeuirequest)
    - [<a name="ttn.lorawan.v3.GetGatewayRequest">Message `GetGatewayRequest`</a>](#message-getgatewayrequest)
      - [Field Rules](#field-rules-113)
    - [<a name="ttn.lorawan.v3.ListGatewayAPIKeysRequest">Message `ListGatewayAPIKeysRequest`</a>](#message-listgatewayapikeysrequest)
      - [Field Rules](#field-rules-114)
    - [<a name="ttn.lorawan.v3.ListGatewayCollaboratorsRequest">Message `ListGatewayCollaboratorsRequest`</a>](#message-listgatewaycollaboratorsrequest)
      - [Field Rules](#field-rules-115)
    - [<a name="ttn.lorawan.v3.ListGatewaysRequest">Message `ListGatewaysRequest`</a>](#message-listgatewaysrequest)
      - [Field Rules](#field-rules-116)
    - [<a name="ttn.lorawan.v3.SetGatewayCollaboratorRequest">Message `SetGatewayCollaboratorRequest`</a>](#message-setgatewaycollaboratorrequest)
      - [Field Rules](#field-rules-117)
    - [<a name="ttn.lorawan.v3.UpdateGatewayAPIKeyRequest">Message `UpdateGatewayAPIKeyRequest`</a>](#message-updategatewayapikeyrequest)
      - [Field Rules](#field-rules-118)
    - [<a name="ttn.lorawan.v3.UpdateGatewayRequest">Message `UpdateGatewayRequest`</a>](#message-updategatewayrequest)
      - [Field Rules](#field-rules-119)
  - [<a name="lorawan-stack/api/gateway_services.proto">File `lorawan-stack/api/gateway_services.proto`</a>](#file-lorawan-stackapigateway_servicesproto)
    - [<a name="ttn.lorawan.v3.PullGatewayConfigurationRequest">Message `PullGatewayConfigurationRequest`</a>](#message-pullgatewayconfigurationrequest)
    - [<a name="ttn.lorawan.v3.GatewayAccess">Service `GatewayAccess`</a>](#service-gatewayaccess)
      - [HTTP bindings](#http-bindings-19)
    - [<a name="ttn.lorawan.v3.GatewayConfigurator">Service `GatewayConfigurator`</a>](#service-gatewayconfigurator)
    - [<a name="ttn.lorawan.v3.GatewayRegistry">Service `GatewayRegistry`</a>](#service-gatewayregistry)
      - [HTTP bindings](#http-bindings-20)
  - [<a name="lorawan-stack/api/gatewayserver.proto">File `lorawan-stack/api/gatewayserver.proto`</a>](#file-lorawan-stackapigatewayserverproto)
    - [<a name="ttn.lorawan.v3.GatewayDown">Message `GatewayDown`</a>](#message-gatewaydown)
    - [<a name="ttn.lorawan.v3.GatewayUp">Message `GatewayUp`</a>](#message-gatewayup)
    - [<a name="ttn.lorawan.v3.ScheduleDownlinkErrorDetails">Message `ScheduleDownlinkErrorDetails`</a>](#message-scheduledownlinkerrordetails)
    - [<a name="ttn.lorawan.v3.ScheduleDownlinkResponse">Message `ScheduleDownlinkResponse`</a>](#message-scheduledownlinkresponse)
      - [Field Rules](#field-rules-120)
    - [<a name="ttn.lorawan.v3.Gs">Service `Gs`</a>](#service-gs)
      - [HTTP bindings](#http-bindings-21)
    - [<a name="ttn.lorawan.v3.GtwGs">Service `GtwGs`</a>](#service-gtwgs)
      - [HTTP bindings](#http-bindings-22)
    - [<a name="ttn.lorawan.v3.NsGs">Service `NsGs`</a>](#service-nsgs)
  - [<a name="lorawan-stack/api/identifiers.proto">File `lorawan-stack/api/identifiers.proto`</a>](#file-lorawan-stackapiidentifiersproto)
    - [<a name="ttn.lorawan.v3.ApplicationIdentifiers">Message `ApplicationIdentifiers`</a>](#message-applicationidentifiers)
      - [Field Rules](#field-rules-121)
    - [<a name="ttn.lorawan.v3.ClientIdentifiers">Message `ClientIdentifiers`</a>](#message-clientidentifiers)
      - [Field Rules](#field-rules-122)
    - [<a name="ttn.lorawan.v3.EndDeviceIdentifiers">Message `EndDeviceIdentifiers`</a>](#message-enddeviceidentifiers)
      - [Field Rules](#field-rules-123)
    - [<a name="ttn.lorawan.v3.EntityIdentifiers">Message `EntityIdentifiers`</a>](#message-entityidentifiers)
    - [<a name="ttn.lorawan.v3.GatewayIdentifiers">Message `GatewayIdentifiers`</a>](#message-gatewayidentifiers)
      - [Field Rules](#field-rules-124)
    - [<a name="ttn.lorawan.v3.OrganizationIdentifiers">Message `OrganizationIdentifiers`</a>](#message-organizationidentifiers)
      - [Field Rules](#field-rules-125)
    - [<a name="ttn.lorawan.v3.OrganizationOrUserIdentifiers">Message `OrganizationOrUserIdentifiers`</a>](#message-organizationoruseridentifiers)
    - [<a name="ttn.lorawan.v3.UserIdentifiers">Message `UserIdentifiers`</a>](#message-useridentifiers)
      - [Field Rules](#field-rules-126)
  - [<a name="lorawan-stack/api/identityserver.proto">File `lorawan-stack/api/identityserver.proto`</a>](#file-lorawan-stackapiidentityserverproto)
    - [<a name="ttn.lorawan.v3.AuthInfoResponse">Message `AuthInfoResponse`</a>](#message-authinforesponse)
    - [<a name="ttn.lorawan.v3.AuthInfoResponse.APIKeyAccess">Message `AuthInfoResponse.APIKeyAccess`</a>](#message-authinforesponseapikeyaccess)
      - [Field Rules](#field-rules-127)
    - [<a name="ttn.lorawan.v3.GetIsConfigurationRequest">Message `GetIsConfigurationRequest`</a>](#message-getisconfigurationrequest)
    - [<a name="ttn.lorawan.v3.GetIsConfigurationResponse">Message `GetIsConfigurationResponse`</a>](#message-getisconfigurationresponse)
    - [<a name="ttn.lorawan.v3.IsConfiguration">Message `IsConfiguration`</a>](#message-isconfiguration)
    - [<a name="ttn.lorawan.v3.IsConfiguration.EndDevicePicture">Message `IsConfiguration.EndDevicePicture`</a>](#message-isconfigurationenddevicepicture)
    - [<a name="ttn.lorawan.v3.IsConfiguration.ProfilePicture">Message `IsConfiguration.ProfilePicture`</a>](#message-isconfigurationprofilepicture)
    - [<a name="ttn.lorawan.v3.IsConfiguration.UserRegistration">Message `IsConfiguration.UserRegistration`</a>](#message-isconfigurationuserregistration)
    - [<a name="ttn.lorawan.v3.IsConfiguration.UserRegistration.AdminApproval">Message `IsConfiguration.UserRegistration.AdminApproval`</a>](#message-isconfigurationuserregistrationadminapproval)
    - [<a name="ttn.lorawan.v3.IsConfiguration.UserRegistration.ContactInfoValidation">Message `IsConfiguration.UserRegistration.ContactInfoValidation`</a>](#message-isconfigurationuserregistrationcontactinfovalidation)
    - [<a name="ttn.lorawan.v3.IsConfiguration.UserRegistration.Invitation">Message `IsConfiguration.UserRegistration.Invitation`</a>](#message-isconfigurationuserregistrationinvitation)
    - [<a name="ttn.lorawan.v3.IsConfiguration.UserRegistration.PasswordRequirements">Message `IsConfiguration.UserRegistration.PasswordRequirements`</a>](#message-isconfigurationuserregistrationpasswordrequirements)
    - [<a name="ttn.lorawan.v3.IsConfiguration.UserRights">Message `IsConfiguration.UserRights`</a>](#message-isconfigurationuserrights)
    - [<a name="ttn.lorawan.v3.EntityAccess">Service `EntityAccess`</a>](#service-entityaccess)
      - [HTTP bindings](#http-bindings-23)
    - [<a name="ttn.lorawan.v3.Is">Service `Is`</a>](#service-is)
      - [HTTP bindings](#http-bindings-24)
  - [<a name="lorawan-stack/api/join.proto">File `lorawan-stack/api/join.proto`</a>](#file-lorawan-stackapijoinproto)
    - [<a name="ttn.lorawan.v3.JoinRequest">Message `JoinRequest`</a>](#message-joinrequest)
      - [Field Rules](#field-rules-128)
    - [<a name="ttn.lorawan.v3.JoinResponse">Message `JoinResponse`</a>](#message-joinresponse)
      - [Field Rules](#field-rules-129)
  - [<a name="lorawan-stack/api/joinserver.proto">File `lorawan-stack/api/joinserver.proto`</a>](#file-lorawan-stackapijoinserverproto)
    - [<a name="ttn.lorawan.v3.AppSKeyResponse">Message `AppSKeyResponse`</a>](#message-appskeyresponse)
      - [Field Rules](#field-rules-130)
    - [<a name="ttn.lorawan.v3.ApplicationActivationSettings">Message `ApplicationActivationSettings`</a>](#message-applicationactivationsettings)
      - [Field Rules](#field-rules-131)
    - [<a name="ttn.lorawan.v3.CryptoServicePayloadRequest">Message `CryptoServicePayloadRequest`</a>](#message-cryptoservicepayloadrequest)
      - [Field Rules](#field-rules-132)
    - [<a name="ttn.lorawan.v3.CryptoServicePayloadResponse">Message `CryptoServicePayloadResponse`</a>](#message-cryptoservicepayloadresponse)
    - [<a name="ttn.lorawan.v3.DeleteApplicationActivationSettingsRequest">Message `DeleteApplicationActivationSettingsRequest`</a>](#message-deleteapplicationactivationsettingsrequest)
    - [<a name="ttn.lorawan.v3.DeriveSessionKeysRequest">Message `DeriveSessionKeysRequest`</a>](#message-derivesessionkeysrequest)
      - [Field Rules](#field-rules-133)
    - [<a name="ttn.lorawan.v3.GetApplicationActivationSettingsRequest">Message `GetApplicationActivationSettingsRequest`</a>](#message-getapplicationactivationsettingsrequest)
    - [<a name="ttn.lorawan.v3.GetRootKeysRequest">Message `GetRootKeysRequest`</a>](#message-getrootkeysrequest)
      - [Field Rules](#field-rules-134)
    - [<a name="ttn.lorawan.v3.JoinAcceptMICRequest">Message `JoinAcceptMICRequest`</a>](#message-joinacceptmicrequest)
      - [Field Rules](#field-rules-135)
    - [<a name="ttn.lorawan.v3.JoinEUIPrefix">Message `JoinEUIPrefix`</a>](#message-joineuiprefix)
    - [<a name="ttn.lorawan.v3.JoinEUIPrefixes">Message `JoinEUIPrefixes`</a>](#message-joineuiprefixes)
    - [<a name="ttn.lorawan.v3.NwkSKeysResponse">Message `NwkSKeysResponse`</a>](#message-nwkskeysresponse)
      - [Field Rules](#field-rules-136)
    - [<a name="ttn.lorawan.v3.ProvisionEndDevicesRequest">Message `ProvisionEndDevicesRequest`</a>](#message-provisionenddevicesrequest)
      - [Field Rules](#field-rules-137)
    - [<a name="ttn.lorawan.v3.ProvisionEndDevicesRequest.IdentifiersFromData">Message `ProvisionEndDevicesRequest.IdentifiersFromData`</a>](#message-provisionenddevicesrequestidentifiersfromdata)
    - [<a name="ttn.lorawan.v3.ProvisionEndDevicesRequest.IdentifiersList">Message `ProvisionEndDevicesRequest.IdentifiersList`</a>](#message-provisionenddevicesrequestidentifierslist)
    - [<a name="ttn.lorawan.v3.ProvisionEndDevicesRequest.IdentifiersRange">Message `ProvisionEndDevicesRequest.IdentifiersRange`</a>](#message-provisionenddevicesrequestidentifiersrange)
    - [<a name="ttn.lorawan.v3.SessionKeyRequest">Message `SessionKeyRequest`</a>](#message-sessionkeyrequest)
      - [Field Rules](#field-rules-138)
    - [<a name="ttn.lorawan.v3.SetApplicationActivationSettingsRequest">Message `SetApplicationActivationSettingsRequest`</a>](#message-setapplicationactivationsettingsrequest)
    - [<a name="ttn.lorawan.v3.ApplicationActivationSettingRegistry">Service `ApplicationActivationSettingRegistry`</a>](#service-applicationactivationsettingregistry)
      - [HTTP bindings](#http-bindings-25)
    - [<a name="ttn.lorawan.v3.ApplicationCryptoService">Service `ApplicationCryptoService`</a>](#service-applicationcryptoservice)
    - [<a name="ttn.lorawan.v3.AsJs">Service `AsJs`</a>](#service-asjs)
    - [<a name="ttn.lorawan.v3.Js">Service `Js`</a>](#service-js)
      - [HTTP bindings](#http-bindings-26)
    - [<a name="ttn.lorawan.v3.JsEndDeviceRegistry">Service `JsEndDeviceRegistry`</a>](#service-jsenddeviceregistry)
      - [HTTP bindings](#http-bindings-27)
    - [<a name="ttn.lorawan.v3.NetworkCryptoService">Service `NetworkCryptoService`</a>](#service-networkcryptoservice)
    - [<a name="ttn.lorawan.v3.NsJs">Service `NsJs`</a>](#service-nsjs)
  - [<a name="lorawan-stack/api/keys.proto">File `lorawan-stack/api/keys.proto`</a>](#file-lorawan-stackapikeysproto)
    - [<a name="ttn.lorawan.v3.KeyEnvelope">Message `KeyEnvelope`</a>](#message-keyenvelope)
      - [Field Rules](#field-rules-139)
    - [<a name="ttn.lorawan.v3.RootKeys">Message `RootKeys`</a>](#message-rootkeys)
      - [Field Rules](#field-rules-140)
    - [<a name="ttn.lorawan.v3.SessionKeys">Message `SessionKeys`</a>](#message-sessionkeys)
      - [Field Rules](#field-rules-141)
  - [<a name="lorawan-stack/api/lorawan.proto">File `lorawan-stack/api/lorawan.proto`</a>](#file-lorawan-stackapilorawanproto)
    - [<a name="ttn.lorawan.v3.ADRAckDelayExponentValue">Message `ADRAckDelayExponentValue`</a>](#message-adrackdelayexponentvalue)
      - [Field Rules](#field-rules-142)
    - [<a name="ttn.lorawan.v3.ADRAckLimitExponentValue">Message `ADRAckLimitExponentValue`</a>](#message-adracklimitexponentvalue)
      - [Field Rules](#field-rules-143)
    - [<a name="ttn.lorawan.v3.AggregatedDutyCycleValue">Message `AggregatedDutyCycleValue`</a>](#message-aggregateddutycyclevalue)
      - [Field Rules](#field-rules-144)
    - [<a name="ttn.lorawan.v3.CFList">Message `CFList`</a>](#message-cflist)
      - [Field Rules](#field-rules-145)
    - [<a name="ttn.lorawan.v3.DLSettings">Message `DLSettings`</a>](#message-dlsettings)
      - [Field Rules](#field-rules-146)
    - [<a name="ttn.lorawan.v3.DataRate">Message `DataRate`</a>](#message-datarate)
    - [<a name="ttn.lorawan.v3.DataRateIndexValue">Message `DataRateIndexValue`</a>](#message-datarateindexvalue)
      - [Field Rules](#field-rules-147)
    - [<a name="ttn.lorawan.v3.DataRateOffsetValue">Message `DataRateOffsetValue`</a>](#message-datarateoffsetvalue)
      - [Field Rules](#field-rules-148)
    - [<a name="ttn.lorawan.v3.DownlinkPath">Message `DownlinkPath`</a>](#message-downlinkpath)
    - [<a name="ttn.lorawan.v3.FCtrl">Message `FCtrl`</a>](#message-fctrl)
    - [<a name="ttn.lorawan.v3.FHDR">Message `FHDR`</a>](#message-fhdr)
      - [Field Rules](#field-rules-149)
    - [<a name="ttn.lorawan.v3.FSKDataRate">Message `FSKDataRate`</a>](#message-fskdatarate)
    - [<a name="ttn.lorawan.v3.FrequencyValue">Message `FrequencyValue`</a>](#message-frequencyvalue)
      - [Field Rules](#field-rules-150)
    - [<a name="ttn.lorawan.v3.GatewayAntennaIdentifiers">Message `GatewayAntennaIdentifiers`</a>](#message-gatewayantennaidentifiers)
      - [Field Rules](#field-rules-151)
    - [<a name="ttn.lorawan.v3.JoinAcceptPayload">Message `JoinAcceptPayload`</a>](#message-joinacceptpayload)
      - [Field Rules](#field-rules-152)
    - [<a name="ttn.lorawan.v3.JoinRequestPayload">Message `JoinRequestPayload`</a>](#message-joinrequestpayload)
    - [<a name="ttn.lorawan.v3.LoRaDataRate">Message `LoRaDataRate`</a>](#message-loradatarate)
    - [<a name="ttn.lorawan.v3.MACCommand">Message `MACCommand`</a>](#message-maccommand)
      - [Field Rules](#field-rules-153)
    - [<a name="ttn.lorawan.v3.MACCommand.ADRParamSetupReq">Message `MACCommand.ADRParamSetupReq`</a>](#message-maccommandadrparamsetupreq)
      - [Field Rules](#field-rules-154)
    - [<a name="ttn.lorawan.v3.MACCommand.BeaconFreqAns">Message `MACCommand.BeaconFreqAns`</a>](#message-maccommandbeaconfreqans)
    - [<a name="ttn.lorawan.v3.MACCommand.BeaconFreqReq">Message `MACCommand.BeaconFreqReq`</a>](#message-maccommandbeaconfreqreq)
      - [Field Rules](#field-rules-155)
    - [<a name="ttn.lorawan.v3.MACCommand.BeaconTimingAns">Message `MACCommand.BeaconTimingAns`</a>](#message-maccommandbeacontimingans)
      - [Field Rules](#field-rules-156)
    - [<a name="ttn.lorawan.v3.MACCommand.DLChannelAns">Message `MACCommand.DLChannelAns`</a>](#message-maccommanddlchannelans)
    - [<a name="ttn.lorawan.v3.MACCommand.DLChannelReq">Message `MACCommand.DLChannelReq`</a>](#message-maccommanddlchannelreq)
      - [Field Rules](#field-rules-157)
    - [<a name="ttn.lorawan.v3.MACCommand.DevStatusAns">Message `MACCommand.DevStatusAns`</a>](#message-maccommanddevstatusans)
      - [Field Rules](#field-rules-158)
    - [<a name="ttn.lorawan.v3.MACCommand.DeviceModeConf">Message `MACCommand.DeviceModeConf`</a>](#message-maccommanddevicemodeconf)
      - [Field Rules](#field-rules-159)
    - [<a name="ttn.lorawan.v3.MACCommand.DeviceModeInd">Message `MACCommand.DeviceModeInd`</a>](#message-maccommanddevicemodeind)
      - [Field Rules](#field-rules-160)
    - [<a name="ttn.lorawan.v3.MACCommand.DeviceTimeAns">Message `MACCommand.DeviceTimeAns`</a>](#message-maccommanddevicetimeans)
      - [Field Rules](#field-rules-161)
    - [<a name="ttn.lorawan.v3.MACCommand.DutyCycleReq">Message `MACCommand.DutyCycleReq`</a>](#message-maccommanddutycyclereq)
      - [Field Rules](#field-rules-162)
    - [<a name="ttn.lorawan.v3.MACCommand.ForceRejoinReq">Message `MACCommand.ForceRejoinReq`</a>](#message-maccommandforcerejoinreq)
      - [Field Rules](#field-rules-163)
    - [<a name="ttn.lorawan.v3.MACCommand.LinkADRAns">Message `MACCommand.LinkADRAns`</a>](#message-maccommandlinkadrans)
    - [<a name="ttn.lorawan.v3.MACCommand.LinkADRReq">Message `MACCommand.LinkADRReq`</a>](#message-maccommandlinkadrreq)
      - [Field Rules](#field-rules-164)
    - [<a name="ttn.lorawan.v3.MACCommand.LinkCheckAns">Message `MACCommand.LinkCheckAns`</a>](#message-maccommandlinkcheckans)
      - [Field Rules](#field-rules-165)
    - [<a name="ttn.lorawan.v3.MACCommand.NewChannelAns">Message `MACCommand.NewChannelAns`</a>](#message-maccommandnewchannelans)
    - [<a name="ttn.lorawan.v3.MACCommand.NewChannelReq">Message `MACCommand.NewChannelReq`</a>](#message-maccommandnewchannelreq)
      - [Field Rules](#field-rules-166)
    - [<a name="ttn.lorawan.v3.MACCommand.PingSlotChannelAns">Message `MACCommand.PingSlotChannelAns`</a>](#message-maccommandpingslotchannelans)
    - [<a name="ttn.lorawan.v3.MACCommand.PingSlotChannelReq">Message `MACCommand.PingSlotChannelReq`</a>](#message-maccommandpingslotchannelreq)
      - [Field Rules](#field-rules-167)
    - [<a name="ttn.lorawan.v3.MACCommand.PingSlotInfoReq">Message `MACCommand.PingSlotInfoReq`</a>](#message-maccommandpingslotinforeq)
      - [Field Rules](#field-rules-168)
    - [<a name="ttn.lorawan.v3.MACCommand.RejoinParamSetupAns">Message `MACCommand.RejoinParamSetupAns`</a>](#message-maccommandrejoinparamsetupans)
    - [<a name="ttn.lorawan.v3.MACCommand.RejoinParamSetupReq">Message `MACCommand.RejoinParamSetupReq`</a>](#message-maccommandrejoinparamsetupreq)
      - [Field Rules](#field-rules-169)
    - [<a name="ttn.lorawan.v3.MACCommand.RekeyConf">Message `MACCommand.RekeyConf`</a>](#message-maccommandrekeyconf)
      - [Field Rules](#field-rules-170)
    - [<a name="ttn.lorawan.v3.MACCommand.RekeyInd">Message `MACCommand.RekeyInd`</a>](#message-maccommandrekeyind)
      - [Field Rules](#field-rules-171)
    - [<a name="ttn.lorawan.v3.MACCommand.ResetConf">Message `MACCommand.ResetConf`</a>](#message-maccommandresetconf)
      - [Field Rules](#field-rules-172)
    - [<a name="ttn.lorawan.v3.MACCommand.ResetInd">Message `MACCommand.ResetInd`</a>](#message-maccommandresetind)
      - [Field Rules](#field-rules-173)
    - [<a name="ttn.lorawan.v3.MACCommand.RxParamSetupAns">Message `MACCommand.RxParamSetupAns`</a>](#message-maccommandrxparamsetupans)
    - [<a name="ttn.lorawan.v3.MACCommand.RxParamSetupReq">Message `MACCommand.RxParamSetupReq`</a>](#message-maccommandrxparamsetupreq)
      - [Field Rules](#field-rules-174)
    - [<a name="ttn.lorawan.v3.MACCommand.RxTimingSetupReq">Message `MACCommand.RxTimingSetupReq`</a>](#message-maccommandrxtimingsetupreq)
      - [Field Rules](#field-rules-175)
    - [<a name="ttn.lorawan.v3.MACCommand.TxParamSetupReq">Message `MACCommand.TxParamSetupReq`</a>](#message-maccommandtxparamsetupreq)
      - [Field Rules](#field-rules-176)
    - [<a name="ttn.lorawan.v3.MACPayload">Message `MACPayload`</a>](#message-macpayload)
      - [Field Rules](#field-rules-177)
    - [<a name="ttn.lorawan.v3.MHDR">Message `MHDR`</a>](#message-mhdr)
      - [Field Rules](#field-rules-178)
    - [<a name="ttn.lorawan.v3.Message">Message `Message`</a>](#message-message)
      - [Field Rules](#field-rules-179)
    - [<a name="ttn.lorawan.v3.PingSlotPeriodValue">Message `PingSlotPeriodValue`</a>](#message-pingslotperiodvalue)
      - [Field Rules](#field-rules-180)
    - [<a name="ttn.lorawan.v3.RejoinRequestPayload">Message `RejoinRequestPayload`</a>](#message-rejoinrequestpayload)
      - [Field Rules](#field-rules-181)
    - [<a name="ttn.lorawan.v3.RxDelayValue">Message `RxDelayValue`</a>](#message-rxdelayvalue)
      - [Field Rules](#field-rules-182)
    - [<a name="ttn.lorawan.v3.TxRequest">Message `TxRequest`</a>](#message-txrequest)
      - [Field Rules](#field-rules-183)
    - [<a name="ttn.lorawan.v3.TxSettings">Message `TxSettings`</a>](#message-txsettings)
      - [Field Rules](#field-rules-184)
    - [<a name="ttn.lorawan.v3.TxSettings.Downlink">Message `TxSettings.Downlink`</a>](#message-txsettingsdownlink)
    - [<a name="ttn.lorawan.v3.UplinkToken">Message `UplinkToken`</a>](#message-uplinktoken)
      - [Field Rules](#field-rules-185)
    - [<a name="ttn.lorawan.v3.ADRAckDelayExponent">Enum `ADRAckDelayExponent`</a>](#enum-adrackdelayexponent)
    - [<a name="ttn.lorawan.v3.ADRAckLimitExponent">Enum `ADRAckLimitExponent`</a>](#enum-adracklimitexponent)
    - [<a name="ttn.lorawan.v3.AggregatedDutyCycle">Enum `AggregatedDutyCycle`</a>](#enum-aggregateddutycycle)
    - [<a name="ttn.lorawan.v3.CFListType">Enum `CFListType`</a>](#enum-cflisttype)
    - [<a name="ttn.lorawan.v3.Class">Enum `Class`</a>](#enum-class)
    - [<a name="ttn.lorawan.v3.DataRateIndex">Enum `DataRateIndex`</a>](#enum-datarateindex)
    - [<a name="ttn.lorawan.v3.DataRateOffset">Enum `DataRateOffset`</a>](#enum-datarateoffset)
    - [<a name="ttn.lorawan.v3.DeviceEIRP">Enum `DeviceEIRP`</a>](#enum-deviceeirp)
    - [<a name="ttn.lorawan.v3.MACCommandIdentifier">Enum `MACCommandIdentifier`</a>](#enum-maccommandidentifier)
    - [<a name="ttn.lorawan.v3.MACVersion">Enum `MACVersion`</a>](#enum-macversion)
    - [<a name="ttn.lorawan.v3.MType">Enum `MType`</a>](#enum-mtype)
    - [<a name="ttn.lorawan.v3.Major">Enum `Major`</a>](#enum-major)
    - [<a name="ttn.lorawan.v3.Minor">Enum `Minor`</a>](#enum-minor)
    - [<a name="ttn.lorawan.v3.PHYVersion">Enum `PHYVersion`</a>](#enum-phyversion)
    - [<a name="ttn.lorawan.v3.PingSlotPeriod">Enum `PingSlotPeriod`</a>](#enum-pingslotperiod)
    - [<a name="ttn.lorawan.v3.RejoinCountExponent">Enum `RejoinCountExponent`</a>](#enum-rejoincountexponent)
    - [<a name="ttn.lorawan.v3.RejoinPeriodExponent">Enum `RejoinPeriodExponent`</a>](#enum-rejoinperiodexponent)
    - [<a name="ttn.lorawan.v3.RejoinTimeExponent">Enum `RejoinTimeExponent`</a>](#enum-rejointimeexponent)
    - [<a name="ttn.lorawan.v3.RejoinType">Enum `RejoinType`</a>](#enum-rejointype)
    - [<a name="ttn.lorawan.v3.RxDelay">Enum `RxDelay`</a>](#enum-rxdelay)
    - [<a name="ttn.lorawan.v3.TxSchedulePriority">Enum `TxSchedulePriority`</a>](#enum-txschedulepriority)
  - [<a name="lorawan-stack/api/message_services.proto">File `lorawan-stack/api/message_services.proto`</a>](#file-lorawan-stackapimessage_servicesproto)
    - [<a name="ttn.lorawan.v3.DecodeDownlinkMessageRequest">Message `DecodeDownlinkMessageRequest`</a>](#message-decodedownlinkmessagerequest)
      - [Field Rules](#field-rules-186)
    - [<a name="ttn.lorawan.v3.DecodeUplinkMessageRequest">Message `DecodeUplinkMessageRequest`</a>](#message-decodeuplinkmessagerequest)
      - [Field Rules](#field-rules-187)
    - [<a name="ttn.lorawan.v3.EncodeDownlinkMessageRequest">Message `EncodeDownlinkMessageRequest`</a>](#message-encodedownlinkmessagerequest)
      - [Field Rules](#field-rules-188)
    - [<a name="ttn.lorawan.v3.MessageProcessor">Service `MessageProcessor`</a>](#service-messageprocessor)
  - [<a name="lorawan-stack/api/messages.proto">File `lorawan-stack/api/messages.proto`</a>](#file-lorawan-stackapimessagesproto)
    - [<a name="ttn.lorawan.v3.ApplicationDownlink">Message `ApplicationDownlink`</a>](#message-applicationdownlink)
      - [Field Rules](#field-rules-189)
    - [<a name="ttn.lorawan.v3.ApplicationDownlink.ClassBC">Message `ApplicationDownlink.ClassBC`</a>](#message-applicationdownlinkclassbc)
    - [<a name="ttn.lorawan.v3.ApplicationDownlinkFailed">Message `ApplicationDownlinkFailed`</a>](#message-applicationdownlinkfailed)
      - [Field Rules](#field-rules-190)
    - [<a name="ttn.lorawan.v3.ApplicationDownlinks">Message `ApplicationDownlinks`</a>](#message-applicationdownlinks)
    - [<a name="ttn.lorawan.v3.ApplicationInvalidatedDownlinks">Message `ApplicationInvalidatedDownlinks`</a>](#message-applicationinvalidateddownlinks)
      - [Field Rules](#field-rules-191)
    - [<a name="ttn.lorawan.v3.ApplicationJoinAccept">Message `ApplicationJoinAccept`</a>](#message-applicationjoinaccept)
      - [Field Rules](#field-rules-192)
    - [<a name="ttn.lorawan.v3.ApplicationLocation">Message `ApplicationLocation`</a>](#message-applicationlocation)
      - [Field Rules](#field-rules-193)
    - [<a name="ttn.lorawan.v3.ApplicationLocation.AttributesEntry">Message `ApplicationLocation.AttributesEntry`</a>](#message-applicationlocationattributesentry)
    - [<a name="ttn.lorawan.v3.ApplicationServiceData">Message `ApplicationServiceData`</a>](#message-applicationservicedata)
    - [<a name="ttn.lorawan.v3.ApplicationUp">Message `ApplicationUp`</a>](#message-applicationup)
      - [Field Rules](#field-rules-194)
    - [<a name="ttn.lorawan.v3.ApplicationUplink">Message `ApplicationUplink`</a>](#message-applicationuplink)
      - [Field Rules](#field-rules-195)
    - [<a name="ttn.lorawan.v3.ApplicationUplink.LocationsEntry">Message `ApplicationUplink.LocationsEntry`</a>](#message-applicationuplinklocationsentry)
    - [<a name="ttn.lorawan.v3.DownlinkMessage">Message `DownlinkMessage`</a>](#message-downlinkmessage)
      - [Field Rules](#field-rules-196)
    - [<a name="ttn.lorawan.v3.DownlinkQueueOperationErrorDetails">Message `DownlinkQueueOperationErrorDetails`</a>](#message-downlinkqueueoperationerrordetails)
      - [Field Rules](#field-rules-197)
    - [<a name="ttn.lorawan.v3.DownlinkQueueRequest">Message `DownlinkQueueRequest`</a>](#message-downlinkqueuerequest)
      - [Field Rules](#field-rules-198)
    - [<a name="ttn.lorawan.v3.GatewayTxAcknowledgment">Message `GatewayTxAcknowledgment`</a>](#message-gatewaytxacknowledgment)
    - [<a name="ttn.lorawan.v3.GatewayUplinkMessage">Message `GatewayUplinkMessage`</a>](#message-gatewayuplinkmessage)
      - [Field Rules](#field-rules-199)
    - [<a name="ttn.lorawan.v3.MessagePayloadFormatters">Message `MessagePayloadFormatters`</a>](#message-messagepayloadformatters)
      - [Field Rules](#field-rules-200)
    - [<a name="ttn.lorawan.v3.TxAcknowledgment">Message `TxAcknowledgment`</a>](#message-txacknowledgment)
      - [Field Rules](#field-rules-201)
    - [<a name="ttn.lorawan.v3.UplinkMessage">Message `UplinkMessage`</a>](#message-uplinkmessage)
      - [Field Rules](#field-rules-202)
    - [<a name="ttn.lorawan.v3.PayloadFormatter">Enum `PayloadFormatter`</a>](#enum-payloadformatter)
    - [<a name="ttn.lorawan.v3.TxAcknowledgment.Result">Enum `TxAcknowledgment.Result`</a>](#enum-txacknowledgmentresult)
  - [<a name="lorawan-stack/api/metadata.proto">File `lorawan-stack/api/metadata.proto`</a>](#file-lorawan-stackapimetadataproto)
    - [<a name="ttn.lorawan.v3.Location">Message `Location`</a>](#message-location)
      - [Field Rules](#field-rules-203)
    - [<a name="ttn.lorawan.v3.PacketBrokerMetadata">Message `PacketBrokerMetadata`</a>](#message-packetbrokermetadata)
    - [<a name="ttn.lorawan.v3.PacketBrokerRouteHop">Message `PacketBrokerRouteHop`</a>](#message-packetbrokerroutehop)
    - [<a name="ttn.lorawan.v3.RxMetadata">Message `RxMetadata`</a>](#message-rxmetadata)
      - [Field Rules](#field-rules-204)
    - [<a name="ttn.lorawan.v3.LocationSource">Enum `LocationSource`</a>](#enum-locationsource)
  - [<a name="lorawan-stack/api/mqtt.proto">File `lorawan-stack/api/mqtt.proto`</a>](#file-lorawan-stackapimqttproto)
    - [<a name="ttn.lorawan.v3.MQTTConnectionInfo">Message `MQTTConnectionInfo`</a>](#message-mqttconnectioninfo)
      - [Field Rules](#field-rules-205)
  - [<a name="lorawan-stack/api/networkserver.proto">File `lorawan-stack/api/networkserver.proto`</a>](#file-lorawan-stackapinetworkserverproto)
    - [<a name="ttn.lorawan.v3.GenerateDevAddrResponse">Message `GenerateDevAddrResponse`</a>](#message-generatedevaddrresponse)
    - [<a name="ttn.lorawan.v3.AsNs">Service `AsNs`</a>](#service-asns)
    - [<a name="ttn.lorawan.v3.GsNs">Service `GsNs`</a>](#service-gsns)
    - [<a name="ttn.lorawan.v3.Ns">Service `Ns`</a>](#service-ns)
      - [HTTP bindings](#http-bindings-28)
    - [<a name="ttn.lorawan.v3.NsEndDeviceRegistry">Service `NsEndDeviceRegistry`</a>](#service-nsenddeviceregistry)
      - [HTTP bindings](#http-bindings-29)
  - [<a name="lorawan-stack/api/oauth.proto">File `lorawan-stack/api/oauth.proto`</a>](#file-lorawan-stackapioauthproto)
    - [<a name="ttn.lorawan.v3.ListOAuthAccessTokensRequest">Message `ListOAuthAccessTokensRequest`</a>](#message-listoauthaccesstokensrequest)
      - [Field Rules](#field-rules-206)
    - [<a name="ttn.lorawan.v3.ListOAuthClientAuthorizationsRequest">Message `ListOAuthClientAuthorizationsRequest`</a>](#message-listoauthclientauthorizationsrequest)
      - [Field Rules](#field-rules-207)
    - [<a name="ttn.lorawan.v3.OAuthAccessToken">Message `OAuthAccessToken`</a>](#message-oauthaccesstoken)
      - [Field Rules](#field-rules-208)
    - [<a name="ttn.lorawan.v3.OAuthAccessTokenIdentifiers">Message `OAuthAccessTokenIdentifiers`</a>](#message-oauthaccesstokenidentifiers)
      - [Field Rules](#field-rules-209)
    - [<a name="ttn.lorawan.v3.OAuthAccessTokens">Message `OAuthAccessTokens`</a>](#message-oauthaccesstokens)
    - [<a name="ttn.lorawan.v3.OAuthAuthorizationCode">Message `OAuthAuthorizationCode`</a>](#message-oauthauthorizationcode)
      - [Field Rules](#field-rules-210)
    - [<a name="ttn.lorawan.v3.OAuthClientAuthorization">Message `OAuthClientAuthorization`</a>](#message-oauthclientauthorization)
      - [Field Rules](#field-rules-211)
    - [<a name="ttn.lorawan.v3.OAuthClientAuthorizationIdentifiers">Message `OAuthClientAuthorizationIdentifiers`</a>](#message-oauthclientauthorizationidentifiers)
      - [Field Rules](#field-rules-212)
    - [<a name="ttn.lorawan.v3.OAuthClientAuthorizations">Message `OAuthClientAuthorizations`</a>](#message-oauthclientauthorizations)
  - [<a name="lorawan-stack/api/oauth_services.proto">File `lorawan-stack/api/oauth_services.proto`</a>](#file-lorawan-stackapioauth_servicesproto)
    - [<a name="ttn.lorawan.v3.OAuthAuthorizationRegistry">Service `OAuthAuthorizationRegistry`</a>](#service-oauthauthorizationregistry)
      - [HTTP bindings](#http-bindings-30)
  - [<a name="lorawan-stack/api/organization.proto">File `lorawan-stack/api/organization.proto`</a>](#file-lorawan-stackapiorganizationproto)
    - [<a name="ttn.lorawan.v3.CreateOrganizationAPIKeyRequest">Message `CreateOrganizationAPIKeyRequest`</a>](#message-createorganizationapikeyrequest)
      - [Field Rules](#field-rules-213)
    - [<a name="ttn.lorawan.v3.CreateOrganizationRequest">Message `CreateOrganizationRequest`</a>](#message-createorganizationrequest)
      - [Field Rules](#field-rules-214)
    - [<a name="ttn.lorawan.v3.GetOrganizationAPIKeyRequest">Message `GetOrganizationAPIKeyRequest`</a>](#message-getorganizationapikeyrequest)
      - [Field Rules](#field-rules-215)
    - [<a name="ttn.lorawan.v3.GetOrganizationCollaboratorRequest">Message `GetOrganizationCollaboratorRequest`</a>](#message-getorganizationcollaboratorrequest)
      - [Field Rules](#field-rules-216)
    - [<a name="ttn.lorawan.v3.GetOrganizationRequest">Message `GetOrganizationRequest`</a>](#message-getorganizationrequest)
      - [Field Rules](#field-rules-217)
    - [<a name="ttn.lorawan.v3.ListOrganizationAPIKeysRequest">Message `ListOrganizationAPIKeysRequest`</a>](#message-listorganizationapikeysrequest)
      - [Field Rules](#field-rules-218)
    - [<a name="ttn.lorawan.v3.ListOrganizationCollaboratorsRequest">Message `ListOrganizationCollaboratorsRequest`</a>](#message-listorganizationcollaboratorsrequest)
      - [Field Rules](#field-rules-219)
    - [<a name="ttn.lorawan.v3.ListOrganizationsRequest">Message `ListOrganizationsRequest`</a>](#message-listorganizationsrequest)
      - [Field Rules](#field-rules-220)
    - [<a name="ttn.lorawan.v3.Organization">Message `Organization`</a>](#message-organization)
      - [Field Rules](#field-rules-221)
    - [<a name="ttn.lorawan.v3.Organization.AttributesEntry">Message `Organization.AttributesEntry`</a>](#message-organizationattributesentry)
    - [<a name="ttn.lorawan.v3.Organizations">Message `Organizations`</a>](#message-organizations)
    - [<a name="ttn.lorawan.v3.SetOrganizationCollaboratorRequest">Message `SetOrganizationCollaboratorRequest`</a>](#message-setorganizationcollaboratorrequest)
      - [Field Rules](#field-rules-222)
    - [<a name="ttn.lorawan.v3.UpdateOrganizationAPIKeyRequest">Message `UpdateOrganizationAPIKeyRequest`</a>](#message-updateorganizationapikeyrequest)
      - [Field Rules](#field-rules-223)
    - [<a name="ttn.lorawan.v3.UpdateOrganizationRequest">Message `UpdateOrganizationRequest`</a>](#message-updateorganizationrequest)
      - [Field Rules](#field-rules-224)
  - [<a name="lorawan-stack/api/organization_services.proto">File `lorawan-stack/api/organization_services.proto`</a>](#file-lorawan-stackapiorganization_servicesproto)
    - [<a name="ttn.lorawan.v3.OrganizationAccess">Service `OrganizationAccess`</a>](#service-organizationaccess)
      - [HTTP bindings](#http-bindings-31)
    - [<a name="ttn.lorawan.v3.OrganizationRegistry">Service `OrganizationRegistry`</a>](#service-organizationregistry)
      - [HTTP bindings](#http-bindings-32)
  - [<a name="lorawan-stack/api/packetbrokeragent.proto">File `lorawan-stack/api/packetbrokeragent.proto`</a>](#file-lorawan-stackapipacketbrokeragentproto)
    - [<a name="ttn.lorawan.v3.ListForwarderRoutingPoliciesRequest">Message `ListForwarderRoutingPoliciesRequest`</a>](#message-listforwarderroutingpoliciesrequest)
    - [<a name="ttn.lorawan.v3.ListHomeNetworkRoutingPoliciesRequest">Message `ListHomeNetworkRoutingPoliciesRequest`</a>](#message-listhomenetworkroutingpoliciesrequest)
      - [Field Rules](#field-rules-225)
    - [<a name="ttn.lorawan.v3.ListHomeNetworksRequest">Message `ListHomeNetworksRequest`</a>](#message-listhomenetworksrequest)
      - [Field Rules](#field-rules-226)
    - [<a name="ttn.lorawan.v3.PacketBrokerDefaultRoutingPolicy">Message `PacketBrokerDefaultRoutingPolicy`</a>](#message-packetbrokerdefaultroutingpolicy)
    - [<a name="ttn.lorawan.v3.PacketBrokerDevAddrBlock">Message `PacketBrokerDevAddrBlock`</a>](#message-packetbrokerdevaddrblock)
    - [<a name="ttn.lorawan.v3.PacketBrokerInfo">Message `PacketBrokerInfo`</a>](#message-packetbrokerinfo)
    - [<a name="ttn.lorawan.v3.PacketBrokerNetwork">Message `PacketBrokerNetwork`</a>](#message-packetbrokernetwork)
    - [<a name="ttn.lorawan.v3.PacketBrokerNetworkIdentifier">Message `PacketBrokerNetworkIdentifier`</a>](#message-packetbrokernetworkidentifier)
      - [Field Rules](#field-rules-227)
    - [<a name="ttn.lorawan.v3.PacketBrokerNetworks">Message `PacketBrokerNetworks`</a>](#message-packetbrokernetworks)
    - [<a name="ttn.lorawan.v3.PacketBrokerRoutingPolicies">Message `PacketBrokerRoutingPolicies`</a>](#message-packetbrokerroutingpolicies)
    - [<a name="ttn.lorawan.v3.PacketBrokerRoutingPolicy">Message `PacketBrokerRoutingPolicy`</a>](#message-packetbrokerroutingpolicy)
    - [<a name="ttn.lorawan.v3.PacketBrokerRoutingPolicyDownlink">Message `PacketBrokerRoutingPolicyDownlink`</a>](#message-packetbrokerroutingpolicydownlink)
    - [<a name="ttn.lorawan.v3.PacketBrokerRoutingPolicyUplink">Message `PacketBrokerRoutingPolicyUplink`</a>](#message-packetbrokerroutingpolicyuplink)
    - [<a name="ttn.lorawan.v3.SetPacketBrokerDefaultRoutingPolicyRequest">Message `SetPacketBrokerDefaultRoutingPolicyRequest`</a>](#message-setpacketbrokerdefaultroutingpolicyrequest)
      - [Field Rules](#field-rules-228)
    - [<a name="ttn.lorawan.v3.SetPacketBrokerRoutingPolicyRequest">Message `SetPacketBrokerRoutingPolicyRequest`</a>](#message-setpacketbrokerroutingpolicyrequest)
      - [Field Rules](#field-rules-229)
    - [<a name="ttn.lorawan.v3.GsPba">Service `GsPba`</a>](#service-gspba)
    - [<a name="ttn.lorawan.v3.NsPba">Service `NsPba`</a>](#service-nspba)
    - [<a name="ttn.lorawan.v3.Pba">Service `Pba`</a>](#service-pba)
      - [HTTP bindings](#http-bindings-33)
  - [<a name="lorawan-stack/api/picture.proto">File `lorawan-stack/api/picture.proto`</a>](#file-lorawan-stackapipictureproto)
    - [<a name="ttn.lorawan.v3.Picture">Message `Picture`</a>](#message-picture)
      - [Field Rules](#field-rules-230)
    - [<a name="ttn.lorawan.v3.Picture.Embedded">Message `Picture.Embedded`</a>](#message-pictureembedded)
      - [Field Rules](#field-rules-231)
    - [<a name="ttn.lorawan.v3.Picture.SizesEntry">Message `Picture.SizesEntry`</a>](#message-picturesizesentry)
  - [<a name="lorawan-stack/api/qrcodegenerator.proto">File `lorawan-stack/api/qrcodegenerator.proto`</a>](#file-lorawan-stackapiqrcodegeneratorproto)
    - [<a name="ttn.lorawan.v3.GenerateEndDeviceQRCodeRequest">Message `GenerateEndDeviceQRCodeRequest`</a>](#message-generateenddeviceqrcoderequest)
      - [Field Rules](#field-rules-232)
    - [<a name="ttn.lorawan.v3.GenerateEndDeviceQRCodeRequest.Image">Message `GenerateEndDeviceQRCodeRequest.Image`</a>](#message-generateenddeviceqrcoderequestimage)
      - [Field Rules](#field-rules-233)
    - [<a name="ttn.lorawan.v3.GenerateQRCodeResponse">Message `GenerateQRCodeResponse`</a>](#message-generateqrcoderesponse)
    - [<a name="ttn.lorawan.v3.GetQRCodeFormatRequest">Message `GetQRCodeFormatRequest`</a>](#message-getqrcodeformatrequest)
      - [Field Rules](#field-rules-234)
    - [<a name="ttn.lorawan.v3.QRCodeFormat">Message `QRCodeFormat`</a>](#message-qrcodeformat)
      - [Field Rules](#field-rules-235)
    - [<a name="ttn.lorawan.v3.QRCodeFormats">Message `QRCodeFormats`</a>](#message-qrcodeformats)
      - [Field Rules](#field-rules-236)
    - [<a name="ttn.lorawan.v3.QRCodeFormats.FormatsEntry">Message `QRCodeFormats.FormatsEntry`</a>](#message-qrcodeformatsformatsentry)
    - [<a name="ttn.lorawan.v3.EndDeviceQRCodeGenerator">Service `EndDeviceQRCodeGenerator`</a>](#service-enddeviceqrcodegenerator)
      - [HTTP bindings](#http-bindings-34)
  - [<a name="lorawan-stack/api/regional.proto">File `lorawan-stack/api/regional.proto`</a>](#file-lorawan-stackapiregionalproto)
    - [<a name="ttn.lorawan.v3.ConcentratorConfig">Message `ConcentratorConfig`</a>](#message-concentratorconfig)
    - [<a name="ttn.lorawan.v3.ConcentratorConfig.Channel">Message `ConcentratorConfig.Channel`</a>](#message-concentratorconfigchannel)
    - [<a name="ttn.lorawan.v3.ConcentratorConfig.FSKChannel">Message `ConcentratorConfig.FSKChannel`</a>](#message-concentratorconfigfskchannel)
    - [<a name="ttn.lorawan.v3.ConcentratorConfig.LBTConfiguration">Message `ConcentratorConfig.LBTConfiguration`</a>](#message-concentratorconfiglbtconfiguration)
    - [<a name="ttn.lorawan.v3.ConcentratorConfig.LoRaStandardChannel">Message `ConcentratorConfig.LoRaStandardChannel`</a>](#message-concentratorconfiglorastandardchannel)
  - [<a name="lorawan-stack/api/rights.proto">File `lorawan-stack/api/rights.proto`</a>](#file-lorawan-stackapirightsproto)
    - [<a name="ttn.lorawan.v3.APIKey">Message `APIKey`</a>](#message-apikey)
      - [Field Rules](#field-rules-237)
    - [<a name="ttn.lorawan.v3.APIKeys">Message `APIKeys`</a>](#message-apikeys)
    - [<a name="ttn.lorawan.v3.Collaborator">Message `Collaborator`</a>](#message-collaborator)
      - [Field Rules](#field-rules-238)
    - [<a name="ttn.lorawan.v3.Collaborators">Message `Collaborators`</a>](#message-collaborators)
    - [<a name="ttn.lorawan.v3.GetCollaboratorResponse">Message `GetCollaboratorResponse`</a>](#message-getcollaboratorresponse)
    - [<a name="ttn.lorawan.v3.Rights">Message `Rights`</a>](#message-rights)
      - [Field Rules](#field-rules-239)
    - [<a name="ttn.lorawan.v3.Right">Enum `Right`</a>](#enum-right)
  - [<a name="lorawan-stack/api/search_services.proto">File `lorawan-stack/api/search_services.proto`</a>](#file-lorawan-stackapisearch_servicesproto)
    - [<a name="ttn.lorawan.v3.SearchApplicationsRequest">Message `SearchApplicationsRequest`</a>](#message-searchapplicationsrequest)
      - [Field Rules](#field-rules-240)
    - [<a name="ttn.lorawan.v3.SearchApplicationsRequest.AttributesContainEntry">Message `SearchApplicationsRequest.AttributesContainEntry`</a>](#message-searchapplicationsrequestattributescontainentry)
    - [<a name="ttn.lorawan.v3.SearchClientsRequest">Message `SearchClientsRequest`</a>](#message-searchclientsrequest)
      - [Field Rules](#field-rules-241)
    - [<a name="ttn.lorawan.v3.SearchClientsRequest.AttributesContainEntry">Message `SearchClientsRequest.AttributesContainEntry`</a>](#message-searchclientsrequestattributescontainentry)
    - [<a name="ttn.lorawan.v3.SearchEndDevicesRequest">Message `SearchEndDevicesRequest`</a>](#message-searchenddevicesrequest)
      - [Field Rules](#field-rules-242)
    - [<a name="ttn.lorawan.v3.SearchEndDevicesRequest.AttributesContainEntry">Message `SearchEndDevicesRequest.AttributesContainEntry`</a>](#message-searchenddevicesrequestattributescontainentry)
    - [<a name="ttn.lorawan.v3.SearchGatewaysRequest">Message `SearchGatewaysRequest`</a>](#message-searchgatewaysrequest)
      - [Field Rules](#field-rules-243)
    - [<a name="ttn.lorawan.v3.SearchGatewaysRequest.AttributesContainEntry">Message `SearchGatewaysRequest.AttributesContainEntry`</a>](#message-searchgatewaysrequestattributescontainentry)
    - [<a name="ttn.lorawan.v3.SearchOrganizationsRequest">Message `SearchOrganizationsRequest`</a>](#message-searchorganizationsrequest)
      - [Field Rules](#field-rules-244)
    - [<a name="ttn.lorawan.v3.SearchOrganizationsRequest.AttributesContainEntry">Message `SearchOrganizationsRequest.AttributesContainEntry`</a>](#message-searchorganizationsrequestattributescontainentry)
    - [<a name="ttn.lorawan.v3.SearchUsersRequest">Message `SearchUsersRequest`</a>](#message-searchusersrequest)
      - [Field Rules](#field-rules-245)
    - [<a name="ttn.lorawan.v3.SearchUsersRequest.AttributesContainEntry">Message `SearchUsersRequest.AttributesContainEntry`</a>](#message-searchusersrequestattributescontainentry)
    - [<a name="ttn.lorawan.v3.EndDeviceRegistrySearch">Service `EndDeviceRegistrySearch`</a>](#service-enddeviceregistrysearch)
      - [HTTP bindings](#http-bindings-35)
    - [<a name="ttn.lorawan.v3.EntityRegistrySearch">Service `EntityRegistrySearch`</a>](#service-entityregistrysearch)
      - [HTTP bindings](#http-bindings-36)
  - [<a name="lorawan-stack/api/secrets.proto">File `lorawan-stack/api/secrets.proto`</a>](#file-lorawan-stackapisecretsproto)
    - [<a name="ttn.lorawan.v3.Secret">Message `Secret`</a>](#message-secret)
      - [Field Rules](#field-rules-246)
  - [<a name="lorawan-stack/api/user.proto">File `lorawan-stack/api/user.proto`</a>](#file-lorawan-stackapiuserproto)
    - [<a name="ttn.lorawan.v3.CreateLoginTokenRequest">Message `CreateLoginTokenRequest`</a>](#message-createlogintokenrequest)
      - [Field Rules](#field-rules-247)
    - [<a name="ttn.lorawan.v3.CreateLoginTokenResponse">Message `CreateLoginTokenResponse`</a>](#message-createlogintokenresponse)
    - [<a name="ttn.lorawan.v3.CreateTemporaryPasswordRequest">Message `CreateTemporaryPasswordRequest`</a>](#message-createtemporarypasswordrequest)
      - [Field Rules](#field-rules-248)
    - [<a name="ttn.lorawan.v3.CreateUserAPIKeyRequest">Message `CreateUserAPIKeyRequest`</a>](#message-createuserapikeyrequest)
      - [Field Rules](#field-rules-249)
    - [<a name="ttn.lorawan.v3.CreateUserRequest">Message `CreateUserRequest`</a>](#message-createuserrequest)
      - [Field Rules](#field-rules-250)
    - [<a name="ttn.lorawan.v3.DeleteInvitationRequest">Message `DeleteInvitationRequest`</a>](#message-deleteinvitationrequest)
      - [Field Rules](#field-rules-251)
    - [<a name="ttn.lorawan.v3.GetUserAPIKeyRequest">Message `GetUserAPIKeyRequest`</a>](#message-getuserapikeyrequest)
      - [Field Rules](#field-rules-252)
    - [<a name="ttn.lorawan.v3.GetUserRequest">Message `GetUserRequest`</a>](#message-getuserrequest)
      - [Field Rules](#field-rules-253)
    - [<a name="ttn.lorawan.v3.Invitation">Message `Invitation`</a>](#message-invitation)
      - [Field Rules](#field-rules-254)
    - [<a name="ttn.lorawan.v3.Invitations">Message `Invitations`</a>](#message-invitations)
    - [<a name="ttn.lorawan.v3.ListInvitationsRequest">Message `ListInvitationsRequest`</a>](#message-listinvitationsrequest)
      - [Field Rules](#field-rules-255)
    - [<a name="ttn.lorawan.v3.ListUserAPIKeysRequest">Message `ListUserAPIKeysRequest`</a>](#message-listuserapikeysrequest)
      - [Field Rules](#field-rules-256)
    - [<a name="ttn.lorawan.v3.ListUserSessionsRequest">Message `ListUserSessionsRequest`</a>](#message-listusersessionsrequest)
      - [Field Rules](#field-rules-257)
    - [<a name="ttn.lorawan.v3.ListUsersRequest">Message `ListUsersRequest`</a>](#message-listusersrequest)
      - [Field Rules](#field-rules-258)
    - [<a name="ttn.lorawan.v3.LoginToken">Message `LoginToken`</a>](#message-logintoken)
      - [Field Rules](#field-rules-259)
    - [<a name="ttn.lorawan.v3.SendInvitationRequest">Message `SendInvitationRequest`</a>](#message-sendinvitationrequest)
      - [Field Rules](#field-rules-260)
    - [<a name="ttn.lorawan.v3.UpdateUserAPIKeyRequest">Message `UpdateUserAPIKeyRequest`</a>](#message-updateuserapikeyrequest)
      - [Field Rules](#field-rules-261)
    - [<a name="ttn.lorawan.v3.UpdateUserPasswordRequest">Message `UpdateUserPasswordRequest`</a>](#message-updateuserpasswordrequest)
      - [Field Rules](#field-rules-262)
    - [<a name="ttn.lorawan.v3.UpdateUserRequest">Message `UpdateUserRequest`</a>](#message-updateuserrequest)
      - [Field Rules](#field-rules-263)
    - [<a name="ttn.lorawan.v3.User">Message `User`</a>](#message-user)
      - [Field Rules](#field-rules-264)
    - [<a name="ttn.lorawan.v3.User.AttributesEntry">Message `User.AttributesEntry`</a>](#message-userattributesentry)
    - [<a name="ttn.lorawan.v3.UserSession">Message `UserSession`</a>](#message-usersession)
      - [Field Rules](#field-rules-265)
    - [<a name="ttn.lorawan.v3.UserSessionIdentifiers">Message `UserSessionIdentifiers`</a>](#message-usersessionidentifiers)
      - [Field Rules](#field-rules-266)
    - [<a name="ttn.lorawan.v3.UserSessions">Message `UserSessions`</a>](#message-usersessions)
    - [<a name="ttn.lorawan.v3.Users">Message `Users`</a>](#message-users)
  - [<a name="lorawan-stack/api/user_services.proto">File `lorawan-stack/api/user_services.proto`</a>](#file-lorawan-stackapiuser_servicesproto)
    - [<a name="ttn.lorawan.v3.UserAccess">Service `UserAccess`</a>](#service-useraccess)
      - [HTTP bindings](#http-bindings-37)
    - [<a name="ttn.lorawan.v3.UserInvitationRegistry">Service `UserInvitationRegistry`</a>](#service-userinvitationregistry)
      - [HTTP bindings](#http-bindings-38)
    - [<a name="ttn.lorawan.v3.UserRegistry">Service `UserRegistry`</a>](#service-userregistry)
      - [HTTP bindings](#http-bindings-39)
    - [<a name="ttn.lorawan.v3.UserSessionRegistry">Service `UserSessionRegistry`</a>](#service-usersessionregistry)
      - [HTTP bindings](#http-bindings-40)
